...
def clearPushed():
    ...
    info_entry.delete(END)

app=Tk()
app.title("Event Management System")
app.geometry("530x500")
...
Label(app, text="Event Info:").grid(row=4, column=0, padx=10, pady=5)
...
appButton = Button(app,text="Create",command=createPushed, width=10).grid(row=5, column=0, padx=10, pady=5)
appButton = Button(app,text="Update",width=10).grid(row=5, column=1, padx=10, pady=5)
appButton = Button(app,text="Clear",command=clearPushed,width=10).grid(row=5, column=2, padx=10, pady=5)
appButton = Button(app,text="Exit",command=exitPushed,width=10).grid(row=6, column=1, padx=10, pady=5)


event_listbox = Listbox(app, width=60, height=13)
event_listbox.grid(row=7, column=0, columnspan=3, padx=10, pady=10)
